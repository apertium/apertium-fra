...
$(TAGGER)/$(LANG1).dic: .deps/fra.dix $(PREFIX).automorf.bin
	@echo "Generating $@";
	@echo "This may take some time. Please, take a cup of coffee and come back later.";
	apertium-validate-dictionary .deps/fra.dix
	apertium-validate-tagger $(BASENAME).$(LANG1).tsx
	lt-expand .deps/fra.dix | grep -v "__REGEXP__" | grep -v ":<:" |\
